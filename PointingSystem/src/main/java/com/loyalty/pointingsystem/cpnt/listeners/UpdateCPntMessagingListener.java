...
@Service
public class UpdateCPntMessagingListener extends CPntMessagingAbstractListener {
	...
	public String getQueueName() {
		return CPntMessagingConfiguration.updateCPntQueueName;
	}
	...
	void handleMessage(CpntMessagingDto cpntMessagingDto) {
		...
		try {
			log.info("attempting to update CpntId: {}", systemCPntId);
			cPntService.updateCPnt(cpntMessagingDto);
			log.info("CpntId: {}, updated", systemCPntId);
